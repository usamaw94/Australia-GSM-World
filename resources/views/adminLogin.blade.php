...
<head>
    ...
    <title>Australia GSM World | Admin Log in</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <div class="login-logo">
            Australia <b>GSM</b> World Admin
        </div>

        <form action="" method="post">
            {{ csrf_field() }}
            <div class="form-group has-feedback">
                <input type="email" class="form-control {{ $errors->has('email') ? ' has-error' : '' }}" value="{{ old('email') }}" placeholder="Email" required autofocus>
            ...
            @endif
            <div class="form-group has-feedback">
                <input type="password" class="form-control {{ $errors->has('password') ? ' has-error' : '' }}" placeholder="Password" required>
